...
function BadVPN () {
wget -O /usr/bin/badvpn-udpgw "https://github.com/00shadow00/deb9vps/badvpn-udpgw?raw=true"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://github.com/00shadow00/deb9vps/badvpn-udpgw64?raw=true"
fi
...
cd /srv
git clone https://github.com/00shadow00/deb9vps/openvpn-monitor.git
cd openvpn-monitor
virtualenv .
. bin/activate
